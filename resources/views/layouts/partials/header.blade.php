                    ...
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex">
                            <div class="user-name text-end me-3">
                                <h6 class="mb-0 text-gray-600">{{ auth()->user()->name ?? auth()->user()->email }}</h6>
                                <p class="mb-0 text-sm text-gray-600">{{ auth()->user()->hasRole('administrator') ? 'Administrator' : 'Operator' }}</p>
                            </div>
