                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb"
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li aria-current="page"
                                class="breadcrumb-item active">{{ $cuti->tanggal_formatted }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('master-data.cuti.update', $cuti->ulid) }}"
                                  method="POST">
                                @method('PUT')
                                @csrf
                                <x-input.date label="Tanggal"
                                              ...
                                              value="{{ old('tanggal', $cuti->tanggal) }}" />
                                <x-input.text label="Deskripsi"
                                              name="deskripsi"
                                              placeholder="Masukkan keterangan cuti"
                                              value="{{ old('deskripsi', $cuti->deskripsi) }}" />
