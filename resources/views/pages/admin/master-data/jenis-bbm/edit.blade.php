                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb"
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li aria-current="page"
                                class="breadcrumb-item active">{{ $jenis_bbm->nama }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('master-data.jenis-bbm.update', $jenis_bbm->ulid) }}"
                                  method="POST">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input aria-describedby="basic-addon2"
                                               ...
                                               step="0.01"
                                               type="number"
                                               value="{{ old('persentase_tarif', $jenis_bbm->persentase_tarif) }}">
...
@push('scripts')
    <script>
        ...
        @if (!is_null(old('is_subsidi', $jenis_bbm->is_subsidi)))
            $('#is_subsidi').val('{{ old('is_subsidi', $jenis_bbm->is_subsidi) == false ? '0' : old('is_subsidi', $jenis_bbm->is_subsidi) }}').trigger('change');
        @endif
    </script>
@endpush
